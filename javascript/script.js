"use strict";
class Animal {
    constructor(id, name, gender, height, age, vaccine, image) {
        this.id = id;
        this.name = name;
        this.gender = gender;
        this.height = height;
...
class Cat extends Animal {
    constructor(id, name, gender, height, age, vaccine, image, breed, furcolor, urlbreed) {
...
class Dog extends Animal {
    constructor(id, name, gender, height, age, vaccine, image, breed, training) {
        super(id, name, gender, height, age, vaccine, image);
        this.breed = breed;
